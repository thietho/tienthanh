...
(function($) {
  ...
  function indent(node, value) {
    ...
    var padding = parseInt(cell.css("padding-left"), 15) + value;
  ...
  function initialize(node) {
    if(!node.hasClass("initialized")) {
      ...
      if(node.hasClass("parent")) {
        var cell = $(node.children("td")[options.treeColumn]);
        var padding = parseInt(cell.css("padding-left"), 15) + options.indent;
	  ...
	  else
	  {
		  ...
		  $(node.children("td")[options.treeColumn]).css("padding-left", padding + "px");
	  }
    }
  };
