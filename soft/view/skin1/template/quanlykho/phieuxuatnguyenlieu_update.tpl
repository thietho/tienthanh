    	...
    	<form name="frm" id="frm" action="<?php echo $action?>" method="post" enctype="multipart/form-data">
            ...
            <div id="container">
                ...
                <div id="fragment-phieuxuatnguyenlieu" class="tabs-container">   
                    ...
                    <input type="hidden" name="loaiphieu" value="xuat-nguyenlieu" />
                    <p>
...
function removeRow(pos,id)
{
	...
	$.ajax({
		url: "?route=quanlykho/phieunhapxuat/updateChiTietPhieuXuat&id="+id+"&phieuxuat=0",
		cache: false,
...
{
	getNguyenLieu("manguyenlieu",val,"like");
}
