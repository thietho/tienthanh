...
<div class="right"><a class="button" href="<?php echo $reply?>" />Reply</a>
...
if(count($attachmentfile)>0)
{
	...
	foreach($attachmentfile as $item)
	{
		...
		{
			?>
<p><img src="<?php echo $item['imagethumbnail']?>" /> <?php echo $item['filename']?>
<a href="<?php echo DIR_FILE?><?php echo $item['filepath']?>"
