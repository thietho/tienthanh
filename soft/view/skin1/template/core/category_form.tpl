...
<div class="button right"><input type="button" value="Save"
	...
	class="button" onclick="linkto('?route=core/category')" /> <input
	type="hidden" name="id" value="<?php echo $item['id']?>"></div>
<div class="clearer">^&nbsp;</div>
<div id="error" class="error" style="display: none"></div>
<div>
<p><label>Category ID</label><br />
<input type="text" name="categoryid"
	value="<?php echo $item['categoryid']?>" class="text" size=60
	<?php if($item['categoryid']!="") echo 'readonly="readonly"'?> /></p>
<p><label>Category name</label><br />
<input type="text" name="categoryname"
	value="<?php echo $item['categoryname']?>" class="text" size=60 /></p>
