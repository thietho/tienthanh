...
<div class="button right"><input class="button" type="button"
	name="save" value="Change" onclick="changePass()" /> <input
	class="button" type="button" name="cancel"
	value="<?php echo $button_cancel?>" onclick="linkto('index.php')" /></div>
<div class="clearer">^&nbsp;</div>

<div class="profile">

<p><label>Current Password</label><br />
<b><input class="text" size="50" name="oldpassword" type="password"
	value="" /></b></p>
