...
<div class="button right"><a class="button"
	href="index.php?route=addon/order"><?php echo $button_cancel?></a></div>
<div class="clearer">^&nbsp;</div>

<div>
<p><label><?php echo $entry_customername?></label><br />
<?php echo $order['customername']?></p>
<p><label><?php echo $entry_email?></label><br />
<?php echo $order['email']?></p>
<p><label><?php echo $entry_address?></label><br />
<?php echo $order['address']?></p>
<p><label><?php echo $entry_phone?></label><br />
<?php echo $order['phone']?></p>
<p><label><?php echo $entry_orderdate?></label><br />
<?php echo $this->date->formatMySQLDate($order['orderdate'])?></p>
<p><label><?php echo $entry_status?></label><br />
<a class="button"
	onclick="activeorder('<?php echo $order['orderid']?>')"><?php echo $order['text_active']?></a>
</p>
<p><label><?php echo $entry_message?></label><br />
<?php echo $order['comment']?></p>
</div>
<div>
<table>
	<thead>
