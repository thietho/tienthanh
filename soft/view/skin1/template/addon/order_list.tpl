    ...
    <div class="section-content">
        ...
        <form action="" method="post" id="listorder" name="listorder">
        	...
        	<div class="button right">
            	<input class="button" type="button" name="delete_all" value="<?php echo $button_cancel?>" onclick="deleteorder()"/>  
            </div>
        ...
        ?>
                    <tr>
                        ...
                        <td><a href="?route=addon/order/view&orderid=<?php echo $order['orderid']?>"><?php echo $order['customername']?></a></td>
