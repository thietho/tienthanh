    ...
    <table>
        ...
        <?php if(count($data_ct)){ ?>
            ...
            <tr>
                ...
                <td>
                	<input type="hidden" name="itemtype[<?php echo $key?>]" value="<?php echo $item['itemtype']?>">
                    <input type="hidden" name="itemid[<?php echo $key?>]" value="<?php echo $item['itemid']?>">
                    <input type="hidden" name="itemcode[<?php echo $key?>]" value="<?php echo $item['itemcode']?>">
                    <input type="hidden" name="itemname[<?php echo $key?>]" value="<?php echo $item['itemname']?>">
