...
<div class="button right"><input type="button" value="Back"
	class="button" onclick="linkto('<?php echo $cancel?>')" /></div>
...
<?php echo $this->date->formatMySQLDate($user['birthday'])?></p>
...
<img id="preview" src="<?php echo $user['imagethumbnail']?>" /></p>
