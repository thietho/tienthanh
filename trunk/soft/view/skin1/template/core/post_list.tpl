...
<div class="right"><?php if($permissionAdd){?> <a class="button"
	href="<?php echo $DIR_ADD?>"><?php echo $button_add?></a>&nbsp; <?php }?>
<?php if($permissionDelete){?> <a class="button" id="removelist"><?php echo $button_remove?></a>&nbsp;
<?php }?> <a class="button" href="index.php"><?php echo $button_cancel?></a>
</div>
...
<table class="data-table" width="100%">
	...
	<?php foreach($medias as $media) {?>
		<tr>
			...
			<td><?php if($permissionEdit){?> <?php echo $media['link']?>&nbsp; <?php }?>
			</td>
		</tr>
		<?php } ?>
	</tbody>
...
<div><?php echo $nextlink?> <?php echo $prevlink?>
<div class="clearer">&nbsp;</div>
</div>
