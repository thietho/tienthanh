...
<div class="left"><a class="button <?php echo $inboxclass?>"
	href="<?php echo $inbox?>"><?php echo $button_inbox?></a>&nbsp; <a
	class="button <?php echo $sendclass?>" href="<?php echo $send?>"><?php echo $button_sendbox?></a>
</div>

<div class="right"><a class="button" href="<?php echo $insert?>"><?php echo $button_send?></a>&nbsp;
<a class="button" onclick="deletelist()">Xóa</a>&nbsp;</div>
	...
	foreach($messages as $item)
	{
		...
		<tr <?php echo $read?>>
			<td class="check-column"><input class="inputchk" type="checkbox"
				name="delete[<?php echo $item['messageid']?>]"
				value="<?php echo $item['messageid']?>"></td>
			<td><?php echo $item['from']?>&nbsp;</td>
			<td><a
				href="<?php echo $view?>&messageid=<?php echo $item['messageid']?>"><?php echo $item['title']?>&nbsp;</a></td>
