...
<div class="button right"><input class="button" type="button"
	name="btnUpdate" value="Update" onclick="updateposition()" /> <input
	...
	foreach($datas as $item)
	{
		...
		<tr id="<?php echo $item['eid']?>" class="<?php echo $item['class']?>">
			...
			<td><?php echo $item['tab']?><input class="inputchk" type="checkbox"
				name="delete[<?php echo $item['categoryid']?>]"
				value="<?php echo $item['categoryid']?>"> <?php echo $item['categoryid']?>
			</td>
			<td><?php echo $item['categoryname']?></td>
			<td><input type="text"
				name="position[<?php echo $item['categoryid']?>]"
				value="<?php echo $item['position']?>" size=3 class="text number" /></td>
			<td class="link-control"><a class="button"
				href="<?php echo $item['link_edit']?>"
				title="<?php echo $item['text_edit']?>"><?php echo $item['text_edit']?></a>
			<a class="button" href="<?php echo $item['link_editcontent']?>"
				title="<?php echo $item['text_editcontent']?>"><?php echo $item['text_editcontent']?></a>
