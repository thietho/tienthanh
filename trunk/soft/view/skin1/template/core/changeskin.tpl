...
<div class="button right"><a class="button" onclick="save()">Save</a> <a
	class="button" href="index.php">Cancel</a></div>
...
<table class="data-table" cellpadding="0" cellspacing="0">
	<tbody>
		<tr class="tr-head">
			<th width="5%"><input class="inputchk" type="checkbox"
		...
		<tr>
			<td class="check-column"><input class="inputchk" type="checkbox"
				name="delete[<?php echo $item['skinid']?>]"
				value="<?php echo $item['skinid']?>"></td>
			<td><?php echo $item['skinid']?></td>
			<td><?php echo $item['skinname']?></td>
			<td><?php echo $item['imagepreview']?></td>

			<td class="link-control"><input type="radio" name="selectskin"
				value="<?php echo $item['skinid']?>"
				<?php if($curentskin == $item['skinid']) echo 'checked="checked"'; ?> />
...
<iframe
	id="printvoucher" src="" width="1px" height="1px"></iframe>
