...
<div class="button right"><a class="button" href="<?php echo $insert?>">Add
new</a> <a class="button" onclick="deletelist()">Delete</a> <a
	...
	<tbody>
		...
		<tr>
			...
			<td class="link-control"><a class="button"
				href="?route=<?php echo $route?>&skinid=<?php echo $item['skinid']?>">Edit</a>
