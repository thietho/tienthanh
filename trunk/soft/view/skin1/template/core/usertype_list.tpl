...
<form action="" name="f"
	method="post"><!-- main indent-->
<div class="indent-center"><!-- <div class="btncontrol">
        <div class="fleft">
            <?php echo $btnAdd?>
...
<table class="tbl" cellpadding="0" cellspacing="0">
	<tbody>
		...
		<tr>
			...
			<td align="right"><?php echo $item['btnAddMember']?> <?php echo $item['btnEdit']?>
