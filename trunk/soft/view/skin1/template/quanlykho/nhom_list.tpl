<div class="section">
	...
	<div class="section-title">Quản lý danh mục phân loại</div>
    ...
    <div class="section-content">
            ...
            <div class="sitemap treeindex">
                ...
                <thead>
                    <tr class="tr-head">
                        ...
                        <th><input class="inputchk" type="checkbox" onclick="$('input[name*=\'delete\']').attr('checked', this.checked);"> Mã nhóm</th>
                        <th>Tên nhóm</th>
                        <th>Thứ tự</th>
                        <th>Ghi chú</th>              
                        <th>Control</th>                                  
        ...
        ?>
                    <tr  id="<?php echo $item['eid']?>" class="<?php echo $item['class']?>">
                        ...
                        <td>
                        	<?php echo $item['tab']?><input class="inputchk" type="checkbox" name="delete[<?php echo $item['manhom']?>]" value="<?php echo $item['manhom']?>" >
                        	<?php echo $item['manhom']?>
                        </td>
                        <td><?php echo $item['tennhom']?></td>
                        <td><input type="text" name="thutu[<?php echo $item['manhom']?>]" value="<?php echo $item['thutu']?>" size=3 class="text number"/></td>
