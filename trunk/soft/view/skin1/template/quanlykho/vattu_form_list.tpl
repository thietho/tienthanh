    ...
    <div class="section-content padding1">
        	...
        	<div class="button right">
            	<input type="button" value="Lưu" class="button" onClick="save(0)"/>
     	        <input type="button" value="Bỏ qua" class="button" onclick="linkto('?route=quanlykho/vattu#page='+control.getParam('page',strurl))"/>   
	...
	$.post("?route=quanlykho/nguyenlieu/save", $("#frm"+i).serialize(),
		function(data){
			...
			else
			{
				...
				window.location = "?route=quanlykho/vattu#page="+control.getParam('page',strurl);
