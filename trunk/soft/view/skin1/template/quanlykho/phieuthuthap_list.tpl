    ...
    <div class="section-content">
        ...
        <form action="" method="post" id="listitem" name="listitem">
        	<div id="ben-search">
                ...
                <input type="text" id="soluongsanxuat" name="soluongsanxuat"  class="text number" />
                 
                 
                <br />
                <input type="button" class="button" name="btnSearch" value="Tìm" onclick="searchForm()"/>
                <input type="button" class="button" name="btnSearch" value="Xem tất cả" onclick="window.location = '?route=quanlykho/phieuthuthap'"/>
            </div>
            <!-- end search -->
        	...
        	<div class="button right">
				...
				<input class="button" type="button" name="cancel" value="Trở lại" onclick="window.location = '?route=quanlykho/phieuthuthap'"/>  
            </div>
