...
<div class="section" id="sitemaplist">
	...
	<div class="section-title">Phiếu khiếu nại</div>
    	...
    	<form name="frm" id="frm" action="<?php echo $action?>" method="post" enctype="multipart/form-data">
        	...
        	<div class="button right">
            	<input type="button" value="Lưu" class="button" onClick="save()"/>
     	        <input type="button" value="Bỏ qua" class="button" onclick="linkto('?route=quanlykho/phieukhieunai')"/>
            ...
            <div id="container">
                ...
                <ul>
                    <li><a href="#fragment-thongtin"><span>Thông tin phiếu khiếu nại</span></a></li>
                </ul>
                <div id="fragment-thongtin">
                	<div id="panelkhieunai" style="display:''">
                    <p>
                    ...
                    <p>
                    	<label>Tên</label><br />
                        <input type="text" id="tenkhachhang" name="tenkhachhang" value="<?php echo $item['tenkhachhang']?>" class="text" size=60 <?php if($item['makhachhang'] != '') echo readonly; ?> />
                    </p>
                    <p>
...
$(document).ready(function() { 
	...
	var khieunai = "<?php echo $item['khieunai']; ?>";
	
	if(khieunai == 'kn')
	{
		$('#panelkhieunai').attr('style', "display:''");
		$('#panelphanhoi').attr('style', 'display:none');
	}
	else
	{
		$('#panelkhieunai').attr('style', 'display:none');
...
function save()
{
	...
	$.post("?route=quanlykho/phieukhieunai/save", $("#frm").serialize(),
		function(data){
			if(data == "true")
			{
				window.location = "?route=quanlykho/phieukhieunai";
			}
			else
			{
