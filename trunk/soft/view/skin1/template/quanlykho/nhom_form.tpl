<div class="section" id="sitemaplist">
	...
	<div class="section-title"><?php echo $heading_title?>Danh mục phan6 loại</div>
    	...
    	<form name="frm" id="frm" action="<?php echo $action?>" method="post" enctype="multipart/form-data">
        	...
        	<div class="button right">
            	<input type="button" value="Save" class="button" onClick="save()"/>
     	        <input type="button" value="Cancel" class="button" onclick="linkto('?route=quanlykho/nhom')"/>   
     	        <input type="hidden" name="curmanhom" value="<?php echo $item['manhom']?>">
            </div>
        	...
        	<div>   
            	<p>
                    ...
                    <input type="text" name="manhom" value="<?php echo $item['manhom']?>" class="text" size=60 <?php if($item['manhom']!="") echo 'readonly="readonly"'?>/>
                </p>     
                <p>
                    <label>Tên danh mục</label><br />
                    <input type="text" name="tennhom" value="<?php echo $item['tennhom']?>" class="text" size=60 />
                </p>
                <p>
