<div class="section">
	...
	<div class="section-title">Quản lý danh mục quyết định giá</div>
    ...
    <div class="section-content">
        ...
        ?>
                    <tr>
                        ...
                        <td><?php echo $item['maquyetdinhgia']?></td>
                        <td><?php echo $this->date->formatMySQLDate($item['ngayraquyetdinh'])?></td>
                        <td><?php echo $item['nguoiraquyetdinh']?></td>
