...
class ControllerQuanlykhoPhieuyeucau extends Controller
{
	private $error = array();
	...
	public function index()
	{
		...
		//$this->load->language('quanlykho/phieuyeucau');
		//$this->data = array_merge($this->data, $this->language->getData());
		
		$this->document->title = $this->language->get('heading_title');
		
		$this->load->model("quanlykho/phieuyeucau");
		$this->getList();
	}
	...
	public function delete() 
	{
		...
		{
			$this->model_quanlykho_phieuyeucau->deleteListPhieuYeuCau($listmaphieu);
	...
	private function getList() 
	{
		...
		$this->data['insert'] = $this->url->http('quanlykho/phieuyeucau/insert');
		$this->data['delete'] = $this->url->http('quanlykho/phieuyeucau/delete');		
		...
		*/
		...
		$rows = $this->model_quanlykho_phieuyeucau->getPhieuYeuCaus($where);
		...
		//for($i=0; $i <= count($this->data['datas'])-1 ; $i++)
		{
			...
			$this->data['datas'][$i]['link_edit'] = $this->url->http('quanlykho/phieuyeucau/update&maphieu='.$this->data['datas'][$i]['maphieu']);
			$this->data['datas'][$i]['text_edit'] = "Sửa";
			
			$this->data['datas'][$i]['link_phanhoi'] = $this->url->http('quanlykho/phieuyeucau/phanhoi&maphieu='.$this->data['datas'][$i]['maphieu']);
			$this->data['datas'][$i]['text_phanhoi'] = "Phản hồi";
			
		}
		$this->data['refres']=$_SERVER['QUERY_STRING'];
		$this->id='content';
		$this->template="quanlykho/phieuyeucau_list.tpl";
	...
	private function getForm($yeucau)
	{
		...
		{
      		$this->data['item'] = $this->model_quanlykho_phieuyeucau->getPhieuYeuCau($this->request->get['maphieu']);
		...
		$this->data['item']['yeucau'] = $yeucau;
		
		$this->id='content';
		$this->template='quanlykho/phieuyeucau_form.tpl';
		$this->layout="layout/center";
	...
	public function save()
	{
		...
		{
			$this->load->model("quanlykho/phieuyeucau");
			$this->model_quanlykho_phieuyeucau->savePhieuYeuCau($data);
