...
<div class="ben-post"><?php if($media['imagethumbnail'] !=""){ ?> <a
	href='<?php echo $media['link']?>'><img
	src='<?php echo $media['imagethumbnail']?>' class='ben-left' /></a> <?php }?>
...
<?php foreach($othernews as $media) {?>
	<li><a href="<?php echo $media['link']?>"><?php echo $media['title']?>&nbsp;<span
...
<div class="ben-post-pagination ben-post-pagination-bottom"><?php echo $prevlink?>
		<?php echo $nextlink?>
<div class="clearer">&nbsp;</div>
</div>
